...
def oi_changes(symbol: str) -> Dict[str, Optional[float]]:
    ...
    out: Dict[str, Optional[float]] = {"oi_now": None, "oi_1h": None, "oi_4h": None, "oi_24h": None}
    ...
    if len(h24) >= 2:
        out["oi_24h"] = pct_change(float(h24[-1].get("sumOpenInterest") or 0), float(h24[0].get("sumOpenInterest") or 0))
